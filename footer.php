...
<footer class="pt-4 md-5 pt-md-5 border-top text-center footer">
    <div class="row">
      <div class="col-md-3 col-lg-3 col-sm-12 col-12">
        ...
        <a href="https://www.facebook.com/FURNITUREVillage-101101894894810/?notif_id=1586712736428775&notif_t=aymt_biz_growth_page_admin_guidance_tip" class="fa fa-facebook"></a>
          <a href="#" class="fa fa-twitter"></a>
          <a href="#" class="fa fa-linkedin"></a>
          <a href="https://www.instagram.com/furniturevillage001/" class="fa fa-instagram"></a>
      </div>
      <br>
      <br>
      <div class="col-md-3 col-lg-3 col-sm-12 col-12">
