        ...
        <div class="col-lg-5 col-sm-12 col-md-6">
            <div class="card-body">
                <div class="card-body">
                    ...
                    <h5 class="card-title text-secondary"><?php echo $row['short_desc']; ?></h5>
                    <h5 class="display-5">&#8377;<?php echo $row['sp']; ?> &nbsp;&#8377;<del><?php echo $row['mrp']; ?> </del></h5>
                    <h6 class="text-muted">Design No: &nbsp;<?php echo $row['design']; ?></h6>
                    <h6 class="text-muted">Height From Groun Level: &nbsp;<?php echo $row['height']; ?>&nbsp;<small>(Inches)</small></h6>
                    <h6 class="text-muted">Dimensions: &nbsp;<?php echo $row['dimensions']; ?>&nbsp;<small>(Inches)</small></h6><br>
                    <form method="post">
                    <label>Qty:</label>
                    <select name="qty">
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><?php echo $row['warranty_info']; ?></p>
