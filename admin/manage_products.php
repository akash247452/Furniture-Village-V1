<?php
    ...
    if(isset($_GET['id']) && $_GET['id']!='')
        {   $req_img='';
            ...
            $e_warranty_info=$row['warranty_info'];
   ...
   if(isset($_POST['submit']))
    {   $name=mysqli_real_escape_string($con,$_POST['name']);
        ...
        $warranty_info=mysqli_real_escape_string($con,$_POST['warranty_info']);
        ...
        if($check==0)
            ...
            {
                if($imagename==''){
                    $update="update products set name='$name' , category_id='$category_id', design='$design', mrp='$mrp', sp='$sp', qty='$qty', 
            dimensions='$dimensions', description='$description', short_desc='$short_desc', height='$height',warranty_info='$warranty_info',meta_tittle= '$meta_tittle',meta_desc= '$meta_desc',meta_keyword= '$meta_keyword'
               where id='$e_id'";
                }
                else{
            ...
            else
            {
                ...
                dimensions, description, short_desc, height, warranty_info, meta_tittle, meta_desc, meta_keyword,
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="form-group"><label class=" form-control-label">Description</label><input type="textarea"  placeholder="Enter description" class="form-control" name='description' value="<?php echo $e_description; ?>" required></div>
                    
                    <div class="form-group"><label class=" form-control-label">Warranty info:</label><input type="text"  placeholder="Enter Warranty info" class="form-control" name='warranty_info' value="<?php echo $e_warranty_info; ?>" required></div>
